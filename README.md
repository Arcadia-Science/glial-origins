...
We examined the impact of using sequence similarity groups (Orthogroups generated by OrthoFinder) or structural similarity groups (Structural clusters generated by FoldSeek clustering of AlphaFold structures) on cross-species gene expression analysis.
...
## Data exploration
If you'd simply like to explore the feature space embeddings we generated in this manuscript, we've built a Binder environment where you can quickly download compressed versions of our data from Zenodo and analyze our data using scanpy. ==TO BE BUILT==

---

# Reproducing our analysis
If you'd like to run our pipelines and analyses for this repository, you'll need the following:
- a Unix machine with at least 32GB of RAM that is able to build a conda environment specified by [glial_origins_tidy.yml](envs/glial_origins_tidy.yml)
...
- a clone of this GitHub repository
    - you should modify the [install_locs.py](envs/install_locs.py) file to reflect the file paths to your local installs of the listed software
